...
### Changed
- README and PyPI metadata now spell out local-file input, SRT/VTT output,
  offline Whisper, and the v0.4.0 extras (batch, chapters, search, Ollama
  summary, faster-whisper) so the project is easier to find.
